...
def intelixlookup(token, type, observable, regionuri) -> dict:
    ...
    if type == "IPv4-Addr" and validators.ipv4(observable):
        ...
        observable = (urllib.parse.quote(observable.encode('utf8')))
        ...
        raise ValueError(
            "Observable not supported by connector"
        )
    ...
    if type == "IPv4-Addr":
        if 'category' in j:
            ...
            if observablecategory == 'malware' or observablecategory == 'botnet' or observablecategory == 'spam_mta' \
                or observablecategory == 'phishing' or observablecategory == 'illegal': 
                response['labelcolor'] = maliciouscolor

            elif observablecategory == 'free_mta' or observablecategory == 'bulk_mta' or observablecategory == 'bulk_mta_grey': 
                response['labelcolor'] = warncolor

            elif observablecategory == 'enduser_network' or observablecategory == 'generic_mta' \
                or observablecategory == 'clean_mta' or observablecategory == 'isp_mta' or observablecategory == 'biz_mta'\
                or observablecategory == 'news_mta' or observablecategory == 'notifications_mta': 
                response['labelcolor'] = goodcolor
